...
export outdir="../output/mocks/mock.bigfile"
export shell_outdir="../output/mocks/angcorr_data/"
export angcorr_outdir="../output/mocks/angcorr_result/"
export tot_mock=100
export density=0.0003
export seed=0
